...
export interface LoadedProductAsset {
...
export interface ProductAssetInstance {
	scene: Object3D;
...
export function disposeLoadedProductAsset(asset: LoadedProductAsset) {
	if (asset.dispose) {
		asset.dispose();
		return;
	}
...
export function createProductAssetInstance(
